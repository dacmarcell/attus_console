...
interface DashboardViewProps {
  ...
  onSimulateIncident: (type: 'TIMEOUT' | 'DATABASE' | 'MEMORY') => Promise<void>
      ...
      <section style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="panel">
          <h2 className="panel-title">
            <Activity size={20} style={{ color: 'var(--accent-color)' }} /> Simulador de Incidentes
          </h2>
          ...
          <div className="simulator-buttons">
            ...
            >
              <div className="simulator-title">
                <WifiOff size={16} style={{ color: 'var(--severity-high)' }} /> Exceção de Timeout
              </div>
            ...
            >
              <div className="simulator-title">
                <Database size={16} style={{ color: 'var(--severity-critical)' }} /> Falha de Banco de Dados
              </div>
            ...
            >
              <div className="simulator-title">
                <Cpu size={16} style={{ color: 'var(--severity-critical)' }} /> Estouro de Memória Heap
              </div>
        ...
        <div className="panel">
          <h2 className="panel-title">
            <Terminal size={20} style={{ color: 'var(--accent-color)' }} /> Ingestão de Log
          </h2>
      ...
      <section>
        ...
        {error && (
          <div className="panel" style={{ borderColor: 'var(--severity-critical)', color: 'var(--severity-critical)', marginBottom: '20px' }}>
            ...
            <strong>Conectividade API:</strong> {error}. Verifique se o backend está ativo na porta 8080.
          </div>
        )}
                ...
                <article key={incident.id} className="incident-card">
                  <div className="incident-header">
                    ...
                    <div className="occurrences-counter">
                      <AlertTriangle size={14} style={{ marginRight: '4px', display: 'inline', verticalAlign: 'middle' }} /> 
